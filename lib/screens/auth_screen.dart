...
class _AuthCardState extends State<AuthCard>
  ...
  void initState() {
    ...
    ); //knows how to animate be'tween' two classes
  ...
  void dispose() {
    super.dispose();
    _controller.dispose(); //to clean the animation
  }
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      const errmsg = 'Could not authenticate u.Please try again later';
      _showErrorDialog(errmsg);
    }
    setState(() {
      _isLoading = false;
  ...
  void _switchAuthMode() {
    if (_authMode == AuthMode.Login) {
      ...
      _controller.reverse(); //reverse play it back
    }
  }
